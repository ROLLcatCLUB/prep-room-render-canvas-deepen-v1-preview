    ...
    const r1iRecommendations = [{"template": "两图对比", "title": "哪一组颜色更安静？", "text": "你从哪些颜色看出来？", "slots": "热闹色彩组合图 / 安静色彩组合图", "reason": "这一段需要学生通过比较说出色彩感受，两图对比比纯文字更适合大屏呈现。", "actions": ["采纳为课件页", "换成三图比较", "暂不生成"]}, {"template": "词卡页", "title": "把“好看”说得更具体", "text": "热烈 / 安静 / 柔和 / 强烈 / 明亮 / 沉稳", "slots": "感觉词卡", "reason": "学生容易只说“好看”，需要语言支架。", "actions": ["采纳为课件页", "改词卡", "暂不生成"]}];
    function renderCoursewareExpandedWorkspace1013JR1(view) {
      return `
