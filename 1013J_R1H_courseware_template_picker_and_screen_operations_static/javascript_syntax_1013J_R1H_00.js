    ...
    const r1hTemplates = [{"template_id": "cover_title", "teacher_label": "封面页", "classroom_use": "课题呈现", "default_slots": "课题、背景图", "whiteboard_required": false}, {"template_id": "one_image_observation", "teacher_label": "一图观察", "classroom_use": "图像观察 / 经验唤醒", "default_slots": "图片、课堂问题", "whiteboard_required": false}, {"template_id": "two_image_comparison", "teacher_label": "两图对比", "classroom_use": "比较观察 / 方法发现 / 审美判断", "default_slots": "图片 A、图片 B、课堂问题", "whiteboard_required": false}, {"template_id": "three_image_comparison", "teacher_label": "三图比较", "classroom_use": "归纳发现 / 作品比较", "default_slots": "图片 A、图片 B、图片 C、课堂问题", "whiteboard_required": false}, {"template_id": "image_with_question", "teacher_label": "图片 + 问题", "classroom_use": "图像导入 / 追问", "default_slots": "主图、问题", "whiteboard_required": false}, {"template_id": "image_annotation", "teacher_label": "图片 + 标注", "classroom_use": "观察支架 / 局部分析", "default_slots": "图片、标注提示", "whiteboard_required": true}, {"template_id": "word_card", "teacher_label": "词卡页", "classroom_use": "表达支架 / 关键词回收", "default_slots": "词卡", "whiteboard_required": false}, {"template_id": "task_release", "teacher_label": "任务发布", "classroom_use": "任务说明 / 操作提示", "default_slots": "任务、要求", "whiteboard_required": false}, {"template_id": "step_demo", "teacher_label": "步骤示范", "classroom_use": "方法学习 / 教师示范", "default_slots": "步骤、示范图", "whiteboard_required": false}, {"template_id": "whiteboard_interaction", "teacher_label": "白板互动", "classroom_use": "色卡试验 / 现场标注", "default_slots": "白板区、操作提示", "whiteboard_required": true}, {"template_id": "student_work_wall", "teacher_label": "学生作品墙", "classroom_use": "展示交流 / 同伴评价", "default_slots": "作品位、交流提示", "whiteboard_required": false}, {"template_id": "evaluation_prompt", "teacher_label": "评价提示", "classroom_use": "展示评价 / 修改反馈", "default_slots": "评价点、修改提示", "whiteboard_required": false}, {"template_id": "summary_review", "teacher_label": "总结回看", "classroom_use": "课堂总结 / 回顾", "default_slots": "总结文字", "whiteboard_required": false}, {"template_id": "custom_blank", "teacher_label": "自定义空白页", "classroom_use": "临时提醒 / 过渡页", "default_slots": "自由内容", "whiteboard_required": false}];
    function renderCoursewareExpandedWorkspace1013JR1(view) {
