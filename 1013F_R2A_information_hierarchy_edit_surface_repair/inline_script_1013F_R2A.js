        ...
        for (let index = 0; index < paragraphs.length; index += 1) {
          ...
          if (currentId === paragraphId) {
            ...
            return {
              ...
              hover: plan.hover,
              notes: [
                ["小备判断", notes[0]?.[1] || plan.hover],
                ["学生可能卡在哪里", notes[1]?.[1] || "这一段暂时没有可用的小备旁注。"],
      ...
      return `
        <section class="nb-side-note-card" data-inline-note>
          ...
          <details class="nb-low-weight-fields">
            ...
            <div>来源段落：${html(context.paragraph)}</div>
          </details>
        </section>
      `;
    }
      ...
      return `
        <div class="nb-edit-panel">
          ...
          <div class="nb-edit-surface">
            ...
            <details class="nb-low-weight-fields">
              <summary>查看低权重来源</summary>
              <div>${html(edit.gap || "当前候选来自教学过程与影响范围推演。")} ${(edit.related || []).map((item) => html(item)).join(" / ")}</div>
            </details>
          </div>
          <div class="nb-edit-tools">
