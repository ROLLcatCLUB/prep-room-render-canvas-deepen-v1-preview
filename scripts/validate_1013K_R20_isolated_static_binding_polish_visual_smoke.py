...
STAGE_ID = "1013K_R20_ISOLATED_STATIC_BINDING_POLISH_VISUAL_SMOKE"
FINAL_STATUS = "PASS_1013K_R20_ISOLATED_STATIC_BINDING_POLISH_VISUAL_SMOKE"
INHERITS_FROM = "1013K_R19_ISOLATED_STATIC_BINDING_READING_SURFACE_POLISH"
NEXT_STAGE = "1013K_R21_ISOLATED_STATIC_BINDING_REVIEW_PACKAGE_MILESTONE"
STAGE_DIR_NAME = "1013K_R20_isolated_static_binding_polish_visual_smoke"
VALIDATOR_NAME = "validate_1013K_R20_isolated_static_binding_polish_visual_smoke.py"
...
def copy_source_delta(root: Path, output_root: Path) -> list[Path]:
    delta_root = output_root / "source_delta_1013K_R20"
...
- `{STAGE_DIR_NAME}/ui_smoke_screenshot_1013K_R20_desktop.png`
- `{STAGE_DIR_NAME}/ui_smoke_screenshot_1013K_R20_mobile.png`
- `{STAGE_DIR_NAME}/isolated_static_binding_polish_visual_smoke_1013K_R20.json`
- `{STAGE_DIR_NAME}/1013K_R20_result.json`
- `{STAGE_DIR_NAME}/1013K_R20_report.md`
...
def build_report(result: dict[str, Any]) -> str:
    return f"""# 1013K_R20 Isolated Static Binding Polish Visual Smoke Report
...
def main() -> int:
    ...
    r19_dir = output_root / "1013K_R19_isolated_static_binding_reading_surface_polish"
    r19_result = read_json(r19_dir / "1013K_R19_result.json")
    html_path = r19_dir / "isolated_static_binding_reading_surface_polish_1013K_R19.html"
    html_text = html_path.read_text(encoding="utf-8")
    stage_dir = output_root / STAGE_DIR_NAME

    browser = find_browser()
    desktop_path = stage_dir / "ui_smoke_screenshot_1013K_R20_desktop.png"
    mobile_path = stage_dir / "ui_smoke_screenshot_1013K_R20_mobile.png"
    ...
    smoke = {
        "visual_smoke_id": "isolated_static_binding_polish_visual_smoke_1013K_R20",
        "stage": STAGE_ID,
        "r19_pass": r19_result.get("validator_pass") is True,
        ...
        "material_prompt_visible_in_html": "还缺教材材料" in html_text,
        "isolated_static_fixture_preserved": 'data-binding-mode="isolated_static_fixture"' in html_text,
        "formal_frontend_page_modified": False,
    ...
    write_json(stage_dir / "isolated_static_binding_polish_visual_smoke_1013K_R20.json", smoke)
    ...
    result = {
        ...
        "isolated_static_fixture_preserved": smoke["isolated_static_fixture_preserved"],
    ...
    for key in [
        ...
        "isolated_static_fixture_preserved",
    ...
    write_json(stage_dir / "1013K_R20_result.json", result)
    write_text(stage_dir / "1013K_R20_report.md", build_report(result))
    print(json.dumps(result, ensure_ascii=False, indent=2))
    if result["validator_pass"]:
        print("ALL_1013K_R20_ISOLATED_STATIC_BINDING_POLISH_VISUAL_SMOKE_CHECKS_OK")
        return 0
    return 1
