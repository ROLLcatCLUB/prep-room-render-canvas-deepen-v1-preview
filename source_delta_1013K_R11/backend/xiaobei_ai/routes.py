...
from . import submission_transfer_routes_0951I
from . import permission_source_readonly_0987KLM
from . import teaching_planning_readonly_routes_0997H
from . import prep_room_feishu_schedule_1013A
from . import account_profile_readonly_adapter_1014A
from . import prep_room_big_unit_readonly_routes_1013K_R11
import os
...
def create_blueprint():
    ...
    if not _workbench_routes_registered:
        ...
        submission_transfer_routes_0951I.register_routes(bp, _cors_preflight)
        ...
        prep_room_feishu_schedule_1013A.register_routes(bp, _cors_preflight)
        account_profile_readonly_adapter_1014A.register_routes(bp, _cors_preflight)
        prep_room_big_unit_readonly_routes_1013K_R11.register_routes(bp, _cors_preflight)
